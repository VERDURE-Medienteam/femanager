...
{
    final const CACHE_IDENTIFIER = 'femanager_ratelimiter';
    final const DEFAULT_CONFIG = ['timeframe' => 60, 'limit' => 3];
    final const LIMIT_IP = 'limit_ip_';
    final const SESSION_KEY = 'tx_femanager_ratelimiter';
